package com.pt.manage.ptweb.repository.statistics;

import com.pt.manage.ptweb.service.statistics.AggregatedStatistics;
...
public interface StatisticsRepository extends JpaRepository<StatisticsEntity, Integer> {
    ...
    @Query(value = "SELECT new com.pt.manage.ptweb.service.statistics.AggregatedStatistics(s.statisticsAt, SUM(s.allCount), SUM(s.attendedCount), SUM(s.cancelledCount)) " +
